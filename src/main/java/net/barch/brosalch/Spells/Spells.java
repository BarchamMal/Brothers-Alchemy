...
public class Spells {
    ...
    public static final Item WEIGHT_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item CURSE_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item VOID_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item EXHAUSTION_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item COLD_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item HARMING_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item DARKNESS_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item DROUGHT_EXTRACT = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE));

    public static final SpellExtractItem REGENERATE_LIMBS = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new RegenerateLimbs(Miscellaneous.POSITIVE,"healing"));
    public static final SpellExtractItem FIRE_TRICK = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new FireTrick(Miscellaneous.NEUTRAL,"fire"));
    public static final SpellExtractItem FLESH_SHIELD = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new FleshShield(Miscellaneous.POSITIVE,"blessing"));
    public static final SpellExtractItem BOLT_OF_ICE = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new BoltOfIce(Miscellaneous.NEGATIVE,"cold"));
    public static final SpellExtractItem FREEZE = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new Freeze(Miscellaneous.NEGATIVE,"curse"));
    public static final SpellExtractItem BIOMECRAFT = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new Biomecraft(Miscellaneous.NEUTRAL,"earth"));
    public static final SpellExtractItem DROP_OUT = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new DropOut(Miscellaneous.NEUTRAL,"void"));
    public static final SpellExtractItem GILLS = new SpellExtractItem(new FabricItemSettings().maxCount(1).maxDamage(16), new Gills(Miscellaneous.POSITIVE,"water"));
    ...
    public static void RegisterItems() {
        ...
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "weight_extract"), WEIGHT_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "curse_extract"), CURSE_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "void_extract"), VOID_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "exhaustion_extract"), EXHAUSTION_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "cold_extract"), COLD_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "harming_extract"), HARMING_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "darkness_extract"), DARKNESS_EXTRACT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "drought_extract"), DROUGHT_EXTRACT);

        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "regenerate_limbs"), REGENERATE_LIMBS);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "fire_trick"), FIRE_TRICK);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "flesh_shield"), FLESH_SHIELD);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "bolt_of_ice"), BOLT_OF_ICE);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "freeze"), FREEZE);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "biomecraft"), BIOMECRAFT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "drop_out"), DROP_OUT);
        Registry.register(Registries.ITEM, new Identifier(NAMESPACE, "gills"), GILLS);
    }

    public static void RegisterEntities() {
        Registry.register(Registries.ENTITY_TYPE, new Identifier(NAMESPACE, "bolt_of_ice"), BOLT_OF_ICE_ENTITY_TYPE);
    }
